...
CREATE TABLE `product_category` (
  ...
  `icon_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '分类图标URL',
  `sort_no` int NOT NULL DEFAULT '0' COMMENT 'Display order',
  `status` tinyint NOT NULL DEFAULT '1' COMMENT '1 enabled, 0 disabled',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `sys_user` (
  ...
  `wx_openid` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '微信小程序 openid（微信一键登录），NULL=未绑定',
  PRIMARY KEY (`id`),
